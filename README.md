...
* Use the [official Gentoo package](https://packages.gentoo.org/packages/x11-misc/autorandr) or the [ebuild from zugaina](https://gpo.zugaina.org/x11-misc/autorandr) on Gentoo.
* Use the
